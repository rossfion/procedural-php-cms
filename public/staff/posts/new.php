...
if (is_post_request()) {
    ...
    redirect_to(url_for('/staff/posts/show.php?id=' . $new_id));
} else {
    $post = [];
...
$page_title = 'PHP CMS | Create Post';
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <h1>Create Post</h1>
            <form action="<?php echo url_for('/staff/posts/new.php'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-10">
                    ...
                    <input class=" date form-control" type="text" name="post_date" id="post_date" value="<?php echo h($post['post_date']); ?>">
                ...
                <div class="form-group">
                    <div class="col-md-10">
                        ...
                        <select name="post_status" id="" value="<?php echo h($post['post_status']); ?>" class="form-control">
                ...
                <div class="form-group">
                    <div class="col-md-10">
                        <button class="btn btn-primary"  type="submit" value="Create Page">Create Page</button>
                    </div>
                </div>
            </form>
