...
if (is_post_request()) {
    $result = approve_comment($id);
    redirect_to(url_for('/staff/comments/index.php'));
} else {
    $comment = find_comment_by_id($id);
}

$page_title = 'Approve Comment';
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <form action="<?php echo url_for('/staff/comments/approve_comment.php?id=' . h(u($comment['comment_id']))); ?>" method="post">
                <div class="form-group">
                    <div class="col-md-10">
                        <button class="btn btn-primary"  type="submit" name="commit" value="Approve Comment" class="form-control">Approve Comment</button>
                    </div>
                </div>
            </form>
